...
public class CreateNewLockedmsg extends BaseClass implements ITestListener {
	...
	public void onStart(ITestContext context) {
		spark=new ExtentSparkReporter("./Extent_Report/Create_Locked_Mesg.html");
		//configure the spark reporter
		spark.config().setDocumentTitle("Create_Locked_mesg Report");
		spark.config().setReportName("Locked-Mesg");
